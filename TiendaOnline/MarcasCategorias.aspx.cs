...
namespace TiendaOnline
{
    public partial class MarcasCategorias : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                // Si necesitás restringir por rol:
        ...
        protected void btnAgregarMarca_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                // Alta: pasar OBJETO (no string) para coincidir con agregar(Marcas m)
        ...
        protected void btnAgregarCategoria_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                // Igual que marcas: pasar OBJETO para coincidir con agregar(Categorias c)
        ...
        protected void gvCategorias_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            {
                int id = Convert.ToInt32(gvCategorias.DataKeys[e.RowIndex].Value);
                categoriasNeg.eliminar(id); // SP bloquea si hay artículos asociados
        ...
        private string GetFriendlySqlError(Exception ex, string fallback)
        {
            ...
            // Borrado con hijos (según tu sp_Categorias_Eliminar)
            ...
            // Duplicados típicos (índice único o validación)
